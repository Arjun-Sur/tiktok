...
function FooterRight({ likes, comments, saves, shares, profilePic, onAddReaction, videoIndex, openPicker, pickerVisible }) {
  ...
  return (
    <div className="footer-right">
      <div className="sidebar-icon" style={{ position: 'relative' }}>
        {!pickerVisible && <MoodCheck onClick={() => openPicker(true)} />}
      </div>
